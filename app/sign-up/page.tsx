  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[100dvh] overflow-x-hidden">
      <div className="flex flex-wrap p-[30px] h-fit w-fit items-center justify-center rounded-[40px] mt-[30px] mb-[50px]">
        <StoryCarousel
          imageSrc={[
            "https://insta-recipe-assets.s3.us-east-1.amazonaws.com/food1.jpeg",
            "https://insta-recipe-assets.s3.us-east-1.amazonaws.com/food2.jpeg",
            "https://insta-recipe-assets.s3.us-east-1.amazonaws.com/food3.jpeg",
          ]}
          seconds={5}
        />
        ...
        <div className="flex flex-col items-center">
          ...
          {/* Display Errors and Confirmation */}
          {signupError && (
            <div className="text-red-500 text-center mb-[20px]">{signupError}</div>
          )}
          {loginError && (
            <div className="text-red-500 text-center mb-[20px]">{loginError}</div>
          )}
          {googleError && (
            <div className="text-red-500 text-center mb-[20px]">{googleError}</div>
          )}
          {confirmationPending && (
